...
class ClockButton: UIButton
{
    ...
    required init?(coder: NSCoder)
    {
        ...
        smallHand.addLine(to: CGPoint(x: thecenter.x + (smalllength - 55.0), y: thecenter.y - 1.0))
        smallHand.addLine(to: CGPoint(x: thecenter.x + (smalllength - 50.0), y: thecenter.y - 7.0))
        ...
        bigHand.addLine(to: CGPoint(x: thecenter.x + (biglength - 40.0), y: thecenter.y - 6.0))
